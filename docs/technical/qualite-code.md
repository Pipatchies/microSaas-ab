...
| --------------- | ----------- | ------------------------------ | ---------------------------------------------------- |
| Linter PEP8     | `flake8`    | `flake8 .`                     | Vérifie la conformité au standard PEP8               |
| Linter Statique | `pylint`    | `pylint src`                   | Vérifie le style et les erreurs courantes de logique |
| Format          | `black`     | `black --check .` ou `black .` | Formate le code selon PEP8                           |
| Tests           | `pytest`    | `pytest`                       | Exécute les tests unitaires                          |
| Sécurité        | `pip-audit` | `pip-audit`                    | Analyse les dépendances vulnérables                  |
